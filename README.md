...
<html amp lang='id'>
  <head>
    ...
    .wind-line {
      ...
      width: 300%;
      height: 10px;
      background: linear-gradient(90deg, transparent, #9c9a82, transparent);
    ...
    .retro-text {
      ...
      font-size: 1.09rem;
      color: #9c9a82;
      text-shadow: 0 0 5px #9c9a82, 0 0 10px #6e5100;
  ...
  <body>
    <div class="container">
      <header>
        <center>
          <a href="https://kepo4dbet.com">
            <amp-img id="image" class="animated tada infinite slower" src="https://miacai-kepo4d.pages.dev/kepo4d-gerak.gif" alt="KEPO4D " width="250" height="80" layout="intrinsic" style="margin-bottom: 10px;"></amp-img>
          </a>
        </center>
      </header>
      <div class="welcome">
      ...
      <a href="https://kepo4d-utama.pages.dev/kosongaja/" target="_blank" rel="noreferrer noopener" role="button" class="btn-menu">DAFTAR KEPO4D</a>
      <p>
      <p class="copyright">@SEO_DBAA > SOLUSI UNTUK NAIK RANK ADA?<a href="https://kepo4dbet.com" rel="noopener noreferrer" style="color: #9c9a82;"></a></p>
      <div class="gold-wind">
      <div class="wind-line"></div>
      <br><br>
      <div class="retro-text"></div>
    </div>
    </div>
  </body>
</html>
